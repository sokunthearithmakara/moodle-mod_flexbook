...
class backup_flexbook_activity_task extends backup_activity_task {
    ...
    public static function encode_content_links($content) {
        ...
        // Link to the list of flexbooks.
        $search = "/(" . $base . "\/mod\/flexbook\/index.php\?id\=)([0-9]+)/";
        $content = preg_replace($search, '$@FLEXBOOKINDEX*$2@$', $content);

        // Link to flexbook view by moduleid.
        $search = "/(" . $base . "\/mod\/flexbook\/view.php\?id\=)([0-9]+)/";
        $content = preg_replace($search, '$@FLEXBOOKVIEWBYID*$2@$', $content);
